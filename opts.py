...
def opt_algorithm():
    ...
    # STN param
    parser.add_argument('--tsu', type=float, default = 0.8, help='coefficient of  l2norm loss between image features and word features')
    parser.add_argument('--tsl', type=float, default = 0.8, help='coefficient of  l2norm loss between image features and word features')
    parser.add_argument('--wul', type=float, default = 1., help='coefficient of  l2norm loss between image features and word features')
    parser.add_argument('--wll', type=float, default = 1., help='coefficient of  l2norm loss between image features and word features')
    parser.add_argument('--wdl', type=float, default = 5., help='coefficient of  l2norm loss between image features and word features')
    parser.add_argument('--waols', type=float, default = 100., help='coefficient of  l2norm loss between image features and word features')
    parser.add_argument('--waolb', type=float, default = 100., help='coefficient of  l2norm loss between image features and word features')
    parser.add_argument('--wrl', type=float, default = 0., help='coefficient of  l2norm loss between image features and word features')
